...
//gcc multithreaded_dna.cpp -I/uufs/chpc.utah.edu/common/home/u1323098/SOFTWARE_COMPARE/include -L/uufs/chpc.utah.edu/common/home/u1323098/SOFTWARE_COMPARE/lib -lparasail -lstdc++ -fopenmp -o multithreaded_dna
//./multithreaded_dna /uufs/chpc.utah.edu/common/home/u1323098/sundar-group-space2/ADEPT/DATA/test-data/dna-reference.fasta /uufs/chpc.utah.edu/common/home/u1323098/sundar-group-space2/ADEPT/DATA/test-data/dna-query.fasta outfile_dna.txt
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <iostream>
...
int main(int argc, char* argv[]) {
   ...
   // Read the first FASTA file and store sequences in a vector
    ...
    int threads=32;
    bool CIGAR = true;
    parasail_matrix_t *dna_matrix = NULL;
    dna_matrix = parasail_matrix_create("ACGT", 3, -3);
...
#pragma omp parallel for
	...
	int thread_id=omp_get_thread_num();
        ...
        result = parasail_sw_trace_striped_sat(que[i].sequence.c_str(), que[i].sequence.size(), ref[i].sequence.c_str(), ref[i].sequence.size(), 6, 1, dna_matrix);
        c_result = parasail_result_get_cigar(result, que[i].sequence.c_str(), que[i].sequence.size(), ref[i].sequence.c_str(), ref[i].sequence.size(), dna_matrix);
	...
	temp_res.cigar = parasail_cigar_decode(c_result);
